...
from access_data import last_timestep
...
def continue_sim(u1, u2, v1, v2, h1, h2, locs, lasttime):
    mode = 1
    ...
    while t <= tmax + dt / 2:
        ...
        if tc % tpl == 0:
            ...
            hf.storedata("v2mat", v2)
            hf.storedata("locsmat", locs)
            hf.storetime(t+lasttime+sampfreq)
...
u1, u2, v1, v2, h1, h2, locs, lasttime = last_timestep("data.nc")
continue_sim(u1, u2, v1, v2, h1, h2, locs, lasttime)
